# Application details
$appFilePath = "bin\Debug\DIPartners.Cambridge.MatchInvoice.mfappx"
...
try
{
	Write-Host "Checking for previous installation of DIPartners.Cambridge.MatchInvoice..."
...
Write-Host "Installing DIPartners.Cambridge.MatchInvoice..."
